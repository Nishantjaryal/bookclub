...
export const quotes = [
  ...
  {
    quote: "There is nothing more powerful than a good story.",
...
export const pros = {
  ...
  points:[
    {
      img:"/assets/ico0.svg",
      text:"Managers can organize lessons to fit the team’s needs with discussion, goal-setting, and tracking built in."
    },
    {
      img:"/assets/ico1.svg",
    ...
    {
      img:"/assets/ico2.svg",
      text:"BookClub curates micro-lessons from the best books on the market."
    }
  ],
