...
const Quotes = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-r from-super to-duper flex-center relative text-white  max-md:py-20">
      <div ref={quoteRef} className="container px-5 py-24 mx-auto">
        <div className="xl:w-[60%] lg:w-3/4 w-full mx-auto text-center ">
          <div className="flex-center gap-2 ">
            <p className="text-[75px] max-md:hidden">“</p>
            <p className=" text-[35px]  max-md:text-[25px] my-font leading-[35px]">
              {myquote}
            </p>
      ...
      <img
        src="/assets/chat.png"
        alt="quotes"
        className="absolute bottom-10 left-10 max-md:hidden"
        width={100}
        height={100}
      />
    </section>
