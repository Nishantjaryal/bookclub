...
const Quotes = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-r from-super to-duper flex-center relative text-white">
      <div className="container px-5 py-24 mx-auto">
        <div className="xl:w-[60%] lg:w-3/4 w-full mx-auto text-center">
        <div className="flex-center gap-2 ">
            <p className="text-[75px]">“</p>
            <p className=" text-[35px] my-font leading-[35px]">{myquote}</p>
            <p className="text-[75px] gap-2">”</p>
        </div>
          
          <span className="inline-block h-1 w-10 rounded bg-white mt-1 mb-6"></span>
          <h2 className=" font-medium title-font tracking-wider text-sm">
            {myauthor}
          </h2>
        </div>
      </div>
      <Image src="/assets/chat.png" alt="quotes" className="absolute bottom-10 left-10" width={100} height={100} />
    </section>
  );
};
