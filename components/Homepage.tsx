...
export default function Home() {
  return (
    <div className="h-screen w-full bg-gradient-to-r from-primary to-secondary flex gap-6 justify-between items-center overflow-hidden max-lg:flex-col max-lg:py-20">
